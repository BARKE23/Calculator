...
public class Calculator {
    ...
    public String calculate(String expression) {
        Stack<String> resultStack = new Stack<String>();//操作数栈
        prepare(expression);//转换为后缀表达式
     ...
     * @return
     */
    private String calculate(String firstValue, String secondValue, char symbol) {
        String result = "";
        ...
        switch (symbol) {
            ...
            case '/':
                if(Double.parseDouble(secondValue) == 0) {
                    ...
                    result = "" + b1.divide(b2, 10, BigDecimal.ROUND_HALF_UP).doubleValue();
                }
                break;
        }
        return result;
